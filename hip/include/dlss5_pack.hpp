// Lossless host-side weight packing for the production fused kernels.
// Ported from the upstream hip_reference:: packed_weights.h (MIT).
#pragma once
#include <cmath>
#include <cstdint>
#include <cstring>
...
// Fragment-native tiles: same 512-byte (16 rows x 32 k) tiles as TilePackedMatrix, but
// inside a tile the bytes are ordered [k/16 within tile][lane half gr][row%16][8 consecutive k].
